...
from MxShop.settings import ALIPAY_ID, app_notify_url, private_key_path, ali_pub_key_path, return_url
...
class ShoppingCartSerializer(serializers.Serializer):
    ...
    # serializers.Serializer要指定model,Modelserializer可不用添加model
